      ...
      >
        ...
        >
          {education.map((edu, index) => (
            <motion.div
              ...
              className="relative"
            >
              <div className="bg-background/50 border border-muted/10 rounded-lg p-8 hover:border-primary/20 transition-all group">
        ...
        {false && ( // quando quiser ocultar ou mostrar certificados é só mudar true/false
          <motion.div
            ...
            className="mt-16"
          >
            <h3 className="text-2xl font-bold mb-8 text-foreground">Certificações</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {certifications.map((cert, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="bg-background/50 border border-muted/10 rounded-lg p-6 hover:border-secondary/20 transition-all group"
                >
